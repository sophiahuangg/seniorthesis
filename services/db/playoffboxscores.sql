...
ALTER TABLE playoffboxscores ALTER COLUMN "firstName" DROP NOT NULL;
CREATE INDEX ON playoffboxscores ("gameId");
CREATE INDEX ON playoffboxscores ("teamId");
CREATE INDEX ON playoffboxscores ("personId");
